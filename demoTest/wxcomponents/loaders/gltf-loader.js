export function registerGLTFLoader(THREE) {
  ...
  THREE.GLTFLoader = (function() {
    ...
    GLTFLoader.prototype = {
      ...
      load: function(url, onLoad, onPageStatus, onProgress, onError) {    
      // load: function (url, onLoad, onProgress, onError) {   
        ...
        let date = new Date();
        let threeStartTime = date.getTime();
        ...
        let date0 = new Date();
        let threeEndTime = date0.getTime();
        ...
        let date1 = new Date();
        let threeEndTime1 = date1.getTime();
        ...
        let date4 = new Date();
        let threeEndTime4 = date4.getTime();
        ...
        if (scope.crossOrigin === 'use-credentials') {
          ...
          let date6 = new Date();
          let threeEndTime6 = date6.getTime();
          // console.log("文件下载类判断后：", (threeEndTime6 - threeStartTime) / 1000 + "s");

        }

        let date5 = new Date();
        let threeEndTime5 = date5.getTime();
        ...
        loader.load(url, function(data) {
          ...
          let date2 = new Date();
          let threeEndTime2 = date2.getTime();
